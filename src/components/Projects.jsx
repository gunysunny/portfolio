...
const projects = [
        {
            ...
            img: starbucksImg,
            desc: [
                "실제 스타벅스 공식 홈페이지의 디자인 및 반응형 레이아웃을 클론코딩하여, 웹 페이지 구조와 스타일링을 심층적으로 학습",
        ...
        },
        {
            ...
            desc: [
                    ...
                    "스크롤 애니메이션, 섹션 전환, 반응형 디자인 등 주요 동적 요소를 HTML, CSS, JavaScript로 직접 구현",
                    "기획부터 분석, 구현, 배포까지 모든 과정을 혼자서 진행하며 실무 퍼블리싱 경험 강화"
                ],
            stack: ["Html", "Css", "Javascript"]
        },
        {
